defmodule BuDuoTravelWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule BuDuoTravel.MyChannel do
        use BuDuoTravelWeb, :channel
        alias BuDuoTravel.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :buDuoTravel,
                        pubsub_server: BuDuoTravel.PubSub
end
